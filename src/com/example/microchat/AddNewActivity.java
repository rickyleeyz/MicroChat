...
public class AddNewActivity extends Activity{
	...
	final Messenger ANMessenger = new Messenger(new ANHandler());
	Messenger NetworkMessager = null;
	boolean mIsBound;
	String newfileName=new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime());
	...
	class ANHandler extends Handler {
        @Override
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        peerAddr = (EditText)findViewById(R.id.NewIPAddr);
        nickName = (EditText)findViewById(R.id.NewNickName);
        photoButton = (ImageView)findViewById(R.id.NewPhoto);
        photoToAdd = Uri.parse("android.resource://com.example.microchat/"+R.drawable.ic_launcher);
        photoButton.setImageURI(photoToAdd);
	...
	public void startChatting(View clickedButton) {
		...
		String chatwith = peerAddr.getText().toString();
		String nickname = nickName.getText().toString();
		if(Utils.isValidIP(chatwith)&&(!nickname.isEmpty())){
			
			Utils.chatHistory.addFriendIP(chatwith);
			Utils.chatHistory.addNewUser(chatwith, nickname,photoToAdd);
			Intent intent = new Intent(AddNewActivity.this, Chat.class);	
			intent.putExtra("peerAddr", peerAddr.getText().toString());
	...
	public void addnewPhoto(View clicked){
		showDialog();
	}
	...
	private void setPicToView(Intent picdata) {
		...
		if (extras != null) {
			...
			photoToAdd = Utils.SaveImage(photo,new SimpleDateFormat("yyyyMMdd_HHmmss").format(Calendar.getInstance().getTime()));
